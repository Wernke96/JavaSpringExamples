...
function createData(name, calories, fat, carbs, protein) {
  ...
  //{ subject, sender, recipient, body, sendDate, attachment};
}
...
//     return rowData
// }
// console.log(fetchData('https://s3rdf9bxgg.execute-api.us-east-2.amazonaws.com/deploy/all'));

const headCells = [
    { id: 'subject', numeric: false, disablePadding: true, label: '' },
...
//const rows = fetchData('https://s3rdf9bxgg.execute-api.us-east-2.amazonaws.com/deploy/all');
// const rows = [
